...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset('vendor/AdminLTE-2.4.13/plugins/iCheck/square/blue.css') }}">
...
<body class="hold-transition login-page">
    ...
    <!-- iCheck -->
    <script src="{{ asset('vendor/AdminLTE-2.4.13/plugins/iCheck/icheck.min.js') }}"></script>
    <script>
        $(function () {
            $('input').iCheck({
